...
<html lang="en-US" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="80">
    <main>
      ...
      <!--      <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="index.html">Bkppd</a>-->
      <!--    </div>-->
      <!--    <div class="collapse navbar-collapse" id="custom-collapse">-->
      <!--      <ul class="nav navbar-nav navbar-right">-->
      <!--        <li class="dropdown"><a  href="https://www.bkppd-balangankab.info" data-toggle="dropdown">Beranda</a></li>      -->
      <!--      </ul>-->
      <!--    </div>-->
      <!--  </div>-->
      <!--</nav>-->
      ...
      <section class="home-section bg-dark-90 portfolio-page-header parallax-bg" id="home" data-background="assets/images/bg-pahlawan.jpg">
        <div class="titan-caption">
          <div class="caption-content">
            ...
            <div class="font-alt mb-5 titan-title-size-3" style="text-shadow:0 7px 5em #000;">Selamat Datang</div>
    ...
    <div class="main">
            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12 col-lg-offset-2">
                <div class="callout-text font-alt">
                  <h4 style="margin-top: 0px; font-;">@timBKPPD</h4>
                  <p style="margin-bottom: 0px;">&copy; 2019 - <?= date('Y') ?> Badan Kepegawaian Pendidikan dan Pelatihan Daerah</p>
                </div>
              </div>
              <div class="col-sm-6 col-md-4 col-lg-2">
                <!--<div class="callout-btn-box"><a class="btn btn-w btn-round" href="#">Semua Aplikasi BKPPD</a></div>-->
              </div>
            </div>
          </div>
        </section>
      ...
      <script>
        ...
        //   if (distance < 0) {
        //     clearInterval(x);
        //     document.getElementById("demo").innerHTML = `<a target="_blank" class="section-scroll btn btn-warning btn-lg mb-10" title="Pengumuman kelulusan cpns balangan ta 2019" href="https://drive.google.com/file/d/14dJnrWBTJ2rFXd55v0LTc2zp35JWeQFL/view?usp=sharing"><span class="fa fa-bullhorn" area-hidden="true"></span>(<span style="color:red;" class="blink">New!!!</span>) <h5>Pengumuman kelulusan cpns balangan ta 2019 </h5></a>`;
        //   }
        // }, 1000);
        </script>
