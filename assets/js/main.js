console.log('%c Hayo Mau APA ?? Ketauin Nih hehe.', 'background: #222; color: #bada55');
    ...
    function templateArticle(data) {
        ...
        <div class="col-sm-6 col-md-4 col-lg-4">
            <div class="post mb-20">
              <div class="post-thumbnail"><a href="${url}"><img src="${img}" alt="Blog-post Thumbnail"/></a></div>
              <div class="post-header font-alt">
                <h2 class="post-title"><a href="${url}">${judul}</a></h2>
                <div class="post-meta">By&nbsp;<a href="${by_link}">${by}</a>&nbsp;| ${tgl} | ${comments} Comments
                </div>
              </div>
