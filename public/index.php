        ...
        <div class="row">
          <div class="col s12">
            <div class="center-align v-center">
              ...
              <a target="_blank" data-position="bottom" data-delay="50" data-tooltip="E-Perilaku" href="https://eprilaku.bkppd-balangankab.info" class="btn-flat btn-large tooltipped waves-effect waves-teal white-text text-lighten-2"><i class="material-icons left">thumb_up_off_alt</i>e-Perilaku</a>
              <a target="_blank" data-position="bottom" data-delay="50" data-tooltip="E-Survei" href="https://ikm.bkppd-balangankab.info" class="btn-flat btn-large tooltipped waves-effect waves-teal white-text text-lighten-2"><i class="material-icons left">check_circle</i>e-Survei</a>
            </div>
          </div>
        </div>
      </div>
